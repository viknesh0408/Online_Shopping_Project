...
<body>
	...
	<table id="customers">
		...
		<tr>
			...
			<td><a href="../cancelOrdersAction?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Cancel <i class='fas fa-window-close'></i></a></td>
			<td><a href="../deliveredOrdersAction?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Delivered <i class='fas fa-dolly'></i></a></td>
		</tr>
		<%}
	       }catch(Exception e){
