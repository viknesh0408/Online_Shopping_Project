...
<body>
	...
	try{
		...
		{
	%>
	<h3>Yuvas Systems and Softwares</h3>
	<hr>
	<div class="left-div">
	...
	<div class="right-div">
		<h3>Mobile Number: <%=rs2.getString(3) %></h3>
	</div>
	...
	<div class="right-div-right">
		<h3>City: <%=rs2.getString(15)%></h3>
	</div>
	<div class="right-div">
		<h3>Address: <%=rs2.getString(14)%></h3>
	</div>

	<div class="left-div">
		<h3>State: <%=rs2.getString(16)%></h3>
	</div>
	<div class="right-div-right">
