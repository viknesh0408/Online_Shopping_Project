...
<body>
	...
	<form action="changePasswordAction" method="post">
		<h3>Enter Old Password</h3>
			<input class="input-style" type="password" name="oldPassword" placeholder="Enter your old Password!">
		<hr>
		<h3>Enter New Password</h3>
			<input class="input-style" type="password" name="newPassword" placeholder="New Password!">
		<hr>
